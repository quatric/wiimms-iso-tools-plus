...
const brsub_info_t brsub_info[] = {
	...
	{ FF_CLR, 0, 3, 4, 1, 2, BIMD_FATAL }, { FF_CLR, 0, 4, 4, 2, 2, BIMD_OK },
	...
	{ FF_SHP, 0, 3, 4, 2, 3, BIMD_FATAL }, { FF_SHP, 0, 4, 4, 3, 3, BIMD_OK },

	{ FF_SRT, 0, 4, 5, 1, 2, BIMD_FATAL },
	{ FF_SRT, 0, 5, 5, 2, 2, BIMD_OK }, // [[2do]] verify hexdump

	{ FF_VIS, 0, 3, 4, 1, 2, BIMD_FATAL }, { FF_VIS, 0, 4, 4, 2, 2, BIMD_OK },
