 ...
 */
#define AV_RB32(p)                                                                                 \
	((uint32_t)((const uint8_t *)(p))[0] << 24 | (uint32_t)((const uint8_t *)(p))[1] << 16         \
...
static const u8 range_limit[1024] = { 0x80, 0x81, 0x82, 0x83, 0x84, 0x85, 0x86, 0x87, 0x88, 0x89,
...
static const u16 gArAANScales[64] = { 16384, 22725, 21407, 19266, 16384, 12873, 8867, 4520, 22725,
	31521, 29692, 26722, 22725, 17855, 12299, 6270, 21407, 29692, 27969, 25172, 21407, 16819, 11585,
	5906, 19266, 26722, 25172, 22654, 19266, 15137, 10426, 5315, 16384, 22725, 21407, 19266, 16384,
	12873, 8867, 4520, 12873, 17855, 16819, 15137, 12873, 10114, 6967, 3552, 8867, 12299, 11585,
	10426, 8867, 6967, 4799, 2446, 4520, 6270, 5906, 5315, 4520, 3552, 2446, 1247 };

static const u32 gArDC_L_Table[16] = { 0x02000000, 0x03000002, 0x03000003, 0x03000004, 0x03000005,
...
static const u32 gArAC_L_Table[16 * 16] = { 0x0400000a, 0x02000000, 0x02000001, 0x03000004,
	...
	0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x0500001c, 0x080000f9, 0x0a0003f7,
	0x0c000ff4, 0x1000ff89, 0x1000ff8a, 0x1000ff8b, 0x1000ff8c, 0x1000ff8d, 0x1000ff8e, 0x00000000,
	0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x0600003a, 0x090001f7, 0x0c000ff5,
	0x1000ff8f, 0x1000ff90, 0x1000ff91, 0x1000ff92, 0x1000ff93, 0x1000ff94, 0x1000ff95, 0x00000000,
	0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x0600003b, 0x0a0003f8, 0x1000ff96,
	0x1000ff97, 0x1000ff98, 0x1000ff99, 0x1000ff9a, 0x1000ff9b, 0x1000ff9c, 0x1000ff9d, 0x00000000,
	0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x0700007a, 0x0b0007f7, 0x1000ff9e,
	0x1000ff9f, 0x1000ffa0, 0x1000ffa1, 0x1000ffa2, 0x1000ffa3, 0x1000ffa4, 0x1000ffa5, 0x00000000,
	0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x0700007b, 0x0c000ff6, 0x1000ffa6,
	0x1000ffa7, 0x1000ffa8, 0x1000ffa9, 0x1000ffaa, 0x1000ffab, 0x1000ffac, 0x1000ffad, 0x00000000,
	0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x080000fa, 0x0c000ff7, 0x1000ffae,
	0x1000ffaf, 0x1000ffb0, 0x1000ffb1, 0x1000ffb2, 0x1000ffb3, 0x1000ffb4, 0x1000ffb5, 0x00000000,
	0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x090001f8, 0x0f007fc0, 0x1000ffb6,
	0x1000ffb7, 0x1000ffb8, 0x1000ffb9, 0x1000ffba, 0x1000ffbb, 0x1000ffbc, 0x1000ffbd, 0x00000000,
	0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x090001f9, 0x1000ffbe, 0x1000ffbf,
	0x1000ffc0, 0x1000ffc1, 0x1000ffc2, 0x1000ffc3, 0x1000ffc4, 0x1000ffc5, 0x1000ffc6, 0x00000000,
	0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x090001fa, 0x1000ffc7, 0x1000ffc8,
	0x1000ffc9, 0x1000ffca, 0x1000ffcb, 0x1000ffcc, 0x1000ffcd, 0x1000ffce, 0x1000ffcf, 0x00000000,
	0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x0a0003f9, 0x1000ffd0, 0x1000ffd1,
	0x1000ffd2, 0x1000ffd3, 0x1000ffd4, 0x1000ffd5, 0x1000ffd6, 0x1000ffd7, 0x1000ffd8, 0x00000000,
	0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x0a0003fa, 0x1000ffd9, 0x1000ffda,
	0x1000ffdb, 0x1000ffdc, 0x1000ffdd, 0x1000ffde, 0x1000ffdf, 0x1000ffe0, 0x1000ffe1, 0x00000000,
	0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x0b0007f8, 0x1000ffe2, 0x1000ffe3,
	0x1000ffe4, 0x1000ffe5, 0x1000ffe6, 0x1000ffe7, 0x1000ffe8, 0x1000ffe9, 0x1000ffea, 0x00000000,
	0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x1000ffeb, 0x1000ffec, 0x1000ffed,
	0x1000ffee, 0x1000ffef, 0x1000fff0, 0x1000fff1, 0x1000fff2, 0x1000fff3, 0x1000fff4, 0x00000000,
	0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x0b0007f9, 0x1000fff5, 0x1000fff6, 0x1000fff7,
	0x1000fff8, 0x1000fff9, 0x1000fffa, 0x1000fffb, 0x1000fffc, 0x1000fffd, 0x1000fffe, 0x00000000,
	0x00000000, 0x00000000, 0x00000000, 0x00000000 };

static const u32 gArDC_C_Table[16] = { 0x02000000, 0x02000001, 0x02000002, 0x03000006, 0x0400000e,
...
static const u32 gArAC_C_Table[16 * 16] = { 0x02000000, 0x02000001, 0x03000004, 0x0400000a,
	...
	0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x0500001a, 0x080000f7, 0x0a0003f7,
	0x0c000ff6, 0x0f007fc2, 0x1000ff8c, 0x1000ff8d, 0x1000ff8e, 0x1000ff8f, 0x1000ff90, 0x00000000,
	0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x0500001b, 0x080000f8, 0x0a0003f8,
	0x0c000ff7, 0x1000ff91, 0x1000ff92, 0x1000ff93, 0x1000ff94, 0x1000ff95, 0x1000ff96, 0x00000000,
	0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x0600003a, 0x090001f6, 0x1000ff97,
	0x1000ff98, 0x1000ff99, 0x1000ff9a, 0x1000ff9b, 0x1000ff9c, 0x1000ff9d, 0x1000ff9e, 0x00000000,
	0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x0600003b, 0x0a0003f9, 0x1000ff9f,
	0x1000ffa0, 0x1000ffa1, 0x1000ffa2, 0x1000ffa3, 0x1000ffa4, 0x1000ffa5, 0x1000ffa6, 0x00000000,
	0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x07000079, 0x0b0007f7, 0x1000ffa7,
	0x1000ffa8, 0x1000ffa9, 0x1000ffaa, 0x1000ffab, 0x1000ffac, 0x1000ffad, 0x1000ffae, 0x00000000,
	0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x0700007a, 0x0b0007f8, 0x1000ffaf,
	0x1000ffb0, 0x1000ffb1, 0x1000ffb2, 0x1000ffb3, 0x1000ffb4, 0x1000ffb5, 0x1000ffb6, 0x00000000,
	0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x080000f9, 0x1000ffb7, 0x1000ffb8,
	0x1000ffb9, 0x1000ffba, 0x1000ffbb, 0x1000ffbc, 0x1000ffbd, 0x1000ffbe, 0x1000ffbf, 0x00000000,
	0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x090001f7, 0x1000ffc0, 0x1000ffc1,
	0x1000ffc2, 0x1000ffc3, 0x1000ffc4, 0x1000ffc5, 0x1000ffc6, 0x1000ffc7, 0x1000ffc8, 0x00000000,
	0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x090001f8, 0x1000ffc9, 0x1000ffca,
	0x1000ffcb, 0x1000ffcc, 0x1000ffcd, 0x1000ffce, 0x1000ffcf, 0x1000ffd0, 0x1000ffd1, 0x00000000,
	0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x090001f9, 0x1000ffd2, 0x1000ffd3,
	0x1000ffd4, 0x1000ffd5, 0x1000ffd6, 0x1000ffd7, 0x1000ffd8, 0x1000ffd9, 0x1000ffda, 0x00000000,
	0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x090001fa, 0x1000ffdb, 0x1000ffdc,
	0x1000ffdd, 0x1000ffde, 0x1000ffdf, 0x1000ffe0, 0x1000ffe1, 0x1000ffe2, 0x1000ffe3, 0x00000000,
	0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x0b0007f9, 0x1000ffe4, 0x1000ffe5,
	0x1000ffe6, 0x1000ffe7, 0x1000ffe8, 0x1000ffe9, 0x1000ffea, 0x1000ffeb, 0x1000ffec, 0x00000000,
	0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x0e003fe0, 0x1000ffed, 0x1000ffee,
	0x1000ffef, 0x1000fff0, 0x1000fff1, 0x1000fff2, 0x1000fff3, 0x1000fff4, 0x1000fff5, 0x00000000,
	0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x0a0003fa, 0x0f007fc3, 0x1000fff6, 0x1000fff7,
	0x1000fff8, 0x1000fff9, 0x1000fffa, 0x1000fffb, 0x1000fffc, 0x1000fffd, 0x1000fffe, 0x00000000,
	0x00000000, 0x00000000, 0x00000000, 0x00000000 };
...
static const u16 *const hufftreePtr[4] = { gArDc_luminance_huffTable, gArDc_luminance_huffTable,
...
static u32 huffmanDecoder (
	u32 *DCTBlock, SArCDJ_HuffmanRequest *huffmanRequest, const u16 *const *hufftree, int col);
static void idct_fast (
	const u8 *range_limit, u32 *quant_table, u32 *DCTBuffer, u8 *output_buf, u32 pixelOffset);

static u32 cdj_c_initializeCompressOdh (SArCDJ_OdhMaster *cdj_ctrl, u16 *imageSize, u8 quality,
	u8 *imgYCbCrBufPtr, u8 *CodeBufPtr, u32 CodeBufSize)
{
	...
	cdj_ctrl->mMCUinImage[DArCDJ_AXIS_X] = (u16)((imageSize[DArCDJ_AXIS_X] - 1)
			/ (DArCDJ_DCT_SIZE_1D * cdj_ctrl->mSmpRate[DArCDJ_AXIS_X])
		+ 1);
	cdj_ctrl->mMCUinImage[DArCDJ_AXIS_Y] = (u16)((imageSize[DArCDJ_AXIS_Y] - 1)
			/ (DArCDJ_DCT_SIZE_1D * cdj_ctrl->mSmpRate[DArCDJ_AXIS_Y])
		+ 1);
...
static u32 cdj_c_compressLoop (SArCDJ_OdhMaster *cdj_ctrl)
{
	...
	do
	{
		...
		if (sampX == 1 && sampY == 1)
		{
			...
			idx = cdj_ctrl->mCurrentMCU[DArCDJ_AXIS_X] * DArCDJ_DCT_SIZE_1D
				+ cdj_ctrl->mCurrentMCU[DArCDJ_AXIS_Y] * DArCDJ_DCT_SIZE_2D
			...
			{
				ODH_DCT_SLOT0 (cdj_ctrl, odh_zigzag_order[i]) = (u16)cdj_ctrl->mDCTBuffer[64 + i];
			}
			...
			for (i = 0; i < DArCDJ_DCT_SIZE_2D; i++)
			{
				ODH_DCT_SLOT1 (cdj_ctrl, odh_zigzag_order[i]) = (u16)cdj_ctrl->mDCTBuffer[64 + i];
			}
		...
		else if (sampX == 2 && sampY == 1)
		{
			...
			idx = cdj_ctrl->mCurrentMCU[DArCDJ_AXIS_X] * DArCDJ_DCT_SIZE_1D * 2
				+ cdj_ctrl->mCurrentMCU[DArCDJ_AXIS_Y] * DArCDJ_DCT_SIZE_2D
					* cdj_ctrl->mMCUinImage[DArCDJ_AXIS_X] * 2;
			pixBlockPtr = &(cdj_ctrl->mImgYCbCrBufferPtr[idx]);
			...
			idx >>= 1;
			idx += DArCDJ_DCT_SIZE_2D * cdj_ctrl->mMCUinImage[DArCDJ_AXIS_X] * 2
				* cdj_ctrl->mMCUinImage[DArCDJ_AXIS_Y];
			pixBlockPtr = &(cdj_ctrl->mImgYCbCrBufferPtr[idx]);
		...
		else if (sampX == 1 && sampY == 2)
		{
			...
			// DCT
			fdct_fast (&cdj_ctrl->mDCTBuffer[64],
				pixBlockPtr + DArCDJ_DCT_SIZE_2D * cdj_ctrl->mMCUinImage[DArCDJ_AXIS_X],
				(u32)(DArCDJ_DCT_SIZE_1D * cdj_ctrl->mMCUinImage[DArCDJ_AXIS_X]),
				cdj_ctrl->mQuantizationTable[0]);
			...
			idx = cdj_ctrl->mCurrentMCU[DArCDJ_AXIS_X] * DArCDJ_DCT_SIZE_1D
				+ cdj_ctrl->mCurrentMCU[DArCDJ_AXIS_Y] * DArCDJ_DCT_SIZE_2D
					* cdj_ctrl->mMCUinImage[DArCDJ_AXIS_X]
				+ DArCDJ_DCT_SIZE_2D * cdj_ctrl->mMCUinImage[DArCDJ_AXIS_X]
					* cdj_ctrl->mMCUinImage[DArCDJ_AXIS_Y] * 2;
			pixBlockPtr = &(cdj_ctrl->mImgYCbCrBufferPtr[idx]);
		...
		else
		{
			...
			idx = cdj_ctrl->mCurrentMCU[DArCDJ_AXIS_X] * DArCDJ_DCT_SIZE_1D * 2
				+ cdj_ctrl->mCurrentMCU[DArCDJ_AXIS_Y] * DArCDJ_DCT_SIZE_2D
					* cdj_ctrl->mMCUinImage[DArCDJ_AXIS_X] * 4;
			pixBlockPtr = &(cdj_ctrl->mImgYCbCrBufferPtr[idx]);
			...
			// idx =
			// cdj_ctrl->mCurrentMCU[DArCDJ_AXIS_X]*DArCDJ_DCT_SIZE_1D*2+cdj_ctrl->mCurrentMCU[DArCDJ_AXIS_Y]*DArCDJ_DCT_SIZE_2D*cdj_ctrl->mMCUinImage[DArCDJ_AXIS_X]*4+DArCDJ_DCT_SIZE_2D*cdj_ctrl->mMCUinImage[DArCDJ_AXIS_X]*2;
			pixBlockPtr = &(cdj_ctrl->mImgYCbCrBufferPtr[idx
				+ DArCDJ_DCT_SIZE_2D * cdj_ctrl->mMCUinImage[DArCDJ_AXIS_X] * 2]);
			...
			idx = cdj_ctrl->mCurrentMCU[DArCDJ_AXIS_X] * DArCDJ_DCT_SIZE_1D
				+ cdj_ctrl->mCurrentMCU[DArCDJ_AXIS_Y] * DArCDJ_DCT_SIZE_2D
					* cdj_ctrl->mMCUinImage[DArCDJ_AXIS_X]
				+ DArCDJ_DCT_SIZE_2D * cdj_ctrl->mMCUinImage[DArCDJ_AXIS_X]
					* cdj_ctrl->mMCUinImage[DArCDJ_AXIS_Y] * 4;
			pixBlockPtr = &(cdj_ctrl->mImgYCbCrBufferPtr[idx]);
...
static void cdj_c_makeHeader (SArCDJ_OdhMaster *cdj_ctrl, u32 fileSize)
{
	...
	AV_WB32 (&cdj_ctrl->mCodeBufferPtr[4],
		(u32)(cdj_ctrl->mImageSize[DArCDJ_AXIS_X] | (cdj_ctrl->mImageSize[DArCDJ_AXIS_Y] << 11)
			| ((cdj_ctrl->mSmpRate[DArCDJ_AXIS_X] - 1) << 22)
	...
	for (i = 0; i < DArCDJ_DCT_SIZE_1D; i++)
	{
		for (j = 0; j < DArCDJ_DCT_SIZE_1D; j++)
		{
			...
			dctBlock[i + j * DArCDJ_DCT_SIZE_1D]
				= (u32)(((int)(dctBlock[i + j * DArCDJ_DCT_SIZE_1D]
								* quantTable[i + j * DArCDJ_DCT_SIZE_1D]
							+ 0x4000))
					>> 15);
		}
	}
...
static av_always_inline u32 EmitBit (s32 code, s32 len, SArCDJ_HuffmanRequest *huffRequest)
{
	...
	*huffRequest->mHuffmanBufferRemain -= len;
	...
	while (*huffRequest->mHuffmanBufferRemain <= 24)
	{
		...
		huffRequest->mCodeBuffer[huffRequest->mCodeBufferSize - *huffRequest->mCodeBufferRemain]
...
static u32 cdj_d_initializeDecompressOdh (
	SArCDJ_OdhMaster *cdj_ctrl, u8 *imgYCbCrBufPtr, u8 *CodeBufPtr, u32 CodeBufSize)
{
	u32 quality;

	if ((CodeBufPtr[0] != 'A') || (CodeBufPtr[1] != 'J') || (CodeBufPtr[2] != 'P')
		|| (CodeBufPtr[3] != 'G'))
	{
		return DArCDJRESULT_ERR_INVALID_DATA;
	}

	cdj_ctrl->mImageSize[DArCDJ_AXIS_X] = (u16)(AV_RB32 (CodeBufPtr + 4) & 0x7ff);

	cdj_ctrl->mImageSize[DArCDJ_AXIS_Y] = (u16)((AV_RB32 (CodeBufPtr + 4) >> 11) & 0x7ff);

	cdj_ctrl->mSmpRate[DArCDJ_AXIS_X] = (u8)(((AV_RB32 (CodeBufPtr + 4) >> 22) & 1) + 1);

	cdj_ctrl->mSmpRate[DArCDJ_AXIS_Y] = (u8)(((AV_RB32 (CodeBufPtr + 4) >> 23) & 1) + 1);

	cdj_ctrl->mQuality = (u8)((AV_RB32 (CodeBufPtr + 4) >> 24) & 0xff);

	if ((!cdj_ctrl->mImageSize[DArCDJ_AXIS_X])
		|| (cdj_ctrl->mImageSize[DArCDJ_AXIS_X] > DArCDJ_PIXEL_SIZE_MAX_X)
		|| (!cdj_ctrl->mImageSize[DArCDJ_AXIS_Y])
		|| (cdj_ctrl->mImageSize[DArCDJ_AXIS_Y] > DArCDJ_PIXEL_SIZE_MAX_Y))
	{
		return DArCDJRESULT_ERR_SIZE;
	}
	...
	cdj_ctrl->mMCUinImage[DArCDJ_AXIS_X] = (u16)((cdj_ctrl->mImageSize[DArCDJ_AXIS_X] - 1)
			/ (DArCDJ_DCT_SIZE_1D * cdj_ctrl->mSmpRate[DArCDJ_AXIS_X])
		+ 1);
	cdj_ctrl->mMCUinImage[DArCDJ_AXIS_Y] = (u16)((cdj_ctrl->mImageSize[DArCDJ_AXIS_Y] - 1)
			/ (DArCDJ_DCT_SIZE_1D * cdj_ctrl->mSmpRate[DArCDJ_AXIS_Y])
		+ 1);
	...
	do
	{
		if ((cdj_ctrl->mSmpRate[DArCDJ_AXIS_X] == 1) && (cdj_ctrl->mSmpRate[DArCDJ_AXIS_Y] == 1))
		{
			...
			result = huffmanDecoder (
				cdj_ctrl->mDCTBuffer, cdj_ctrl->mHuffmanRequest, hufftreePtr, DArCDJ_COLOR_Y);

			(cdj_ctrl->mHuffmanRequest[1]).mCodeBuffer = (cdj_ctrl->mHuffmanRequest[0]).mCodeBuffer;
			...
			for (i = 0; i < 64; i++)
			{
				cdj_ctrl->mDCTBuffer[odh_natural_order[i] + 64] = cdj_ctrl->mDCTBuffer[i];
			}

			idx = DArCDJ_DCT_SIZE_1D * cdj_ctrl->mCurrentMCU[DArCDJ_AXIS_X]
				+ DArCDJ_DCT_SIZE_2D * cdj_ctrl->mCurrentMCU[DArCDJ_AXIS_Y]
					* cdj_ctrl->mMCUinImage[DArCDJ_AXIS_X];

			idct_fast (range_limit, cdj_ctrl->mQuantizationTable[0], &(cdj_ctrl->mDCTBuffer[64]),
				&(cdj_ctrl->mImgYCbCrBufferPtr[idx]),
				(u32)DArCDJ_DCT_SIZE_1D * cdj_ctrl->mMCUinImage[DArCDJ_AXIS_X]);

			result = huffmanDecoder (cdj_ctrl->mDCTBuffer, cdj_ctrl->mHuffmanRequest + 1,
			...
			idct_fast (range_limit, cdj_ctrl->mQuantizationTable[1], &(cdj_ctrl->mDCTBuffer[64]),
				&(cdj_ctrl->mImgYCbCrBufferPtr[idx]),
				(u32)DArCDJ_DCT_SIZE_1D * cdj_ctrl->mMCUinImage[DArCDJ_AXIS_X]);
			...
			(cdj_ctrl->mHuffmanRequest[0]).mCodeBuffer = (cdj_ctrl->mHuffmanRequest[1]).mCodeBuffer;
		...
		else if ((cdj_ctrl->mSmpRate[DArCDJ_AXIS_X] == 2)
			&& (cdj_ctrl->mSmpRate[DArCDJ_AXIS_Y] == 1))
		{
			...
			idx = DArCDJ_DCT_SIZE_1D * cdj_ctrl->mCurrentMCU[DArCDJ_AXIS_X] * 2
				+ DArCDJ_DCT_SIZE_2D * cdj_ctrl->mCurrentMCU[DArCDJ_AXIS_Y]
					* cdj_ctrl->mMCUinImage[DArCDJ_AXIS_X] * 2;
		...
		else if ((cdj_ctrl->mSmpRate[DArCDJ_AXIS_X] == 1)
			&& (cdj_ctrl->mSmpRate[DArCDJ_AXIS_Y] == 2))
		{
			...
			&& (cdj_ctrl->mSmpRate[DArCDJ_AXIS_Y] == 2))
		{
			...
			idx = DArCDJ_DCT_SIZE_1D * cdj_ctrl->mCurrentMCU[DArCDJ_AXIS_X]
				+ DArCDJ_DCT_SIZE_2D * cdj_ctrl->mCurrentMCU[DArCDJ_AXIS_Y]
					* cdj_ctrl->mMCUinImage[DArCDJ_AXIS_X]
				+ DArCDJ_DCT_SIZE_2D * cdj_ctrl->mMCUinImage[DArCDJ_AXIS_X]
					* cdj_ctrl->mMCUinImage[DArCDJ_AXIS_Y] * 8;
	...
	const u8 *range_limit, u32 *quant_table, u32 *DCTBuffer, u8 *output_buf, u32 pixelOffset)
{
	...
	for (ctr = DArCDJ_DCT_SIZE_1D; ctr > 0; ctr--)
	{
		...
		if ((inptr[DArCDJ_DCT_SIZE_1D * 1] == 0) && (inptr[DArCDJ_DCT_SIZE_1D * 2] == 0)
			&& (inptr[DArCDJ_DCT_SIZE_1D * 3] == 0) && (inptr[DArCDJ_DCT_SIZE_1D * 4] == 0)
			&& (inptr[DArCDJ_DCT_SIZE_1D * 5] == 0) && (inptr[DArCDJ_DCT_SIZE_1D * 6] == 0)
			&& (inptr[DArCDJ_DCT_SIZE_1D * 7] == 0))
		{
			/* AC terms all zero */
...
static void odh_plane_layout (const SArCDJ_OdhMaster *ctrl, int *luma_stride, int *chroma_stride,
	size_t *cb_off, size_t *cr_off, size_t *total)
{
	const size_t unit = (size_t)DArCDJ_DCT_SIZE_2D * ctrl->mMCUinImage[DArCDJ_AXIS_X]
		* ctrl->mMCUinImage[DArCDJ_AXIS_Y];
	const size_t samp = (size_t)ctrl->mSmpRate[DArCDJ_AXIS_X] * ctrl->mSmpRate[DArCDJ_AXIS_Y];

	*luma_stride
		= DArCDJ_DCT_SIZE_1D * ctrl->mMCUinImage[DArCDJ_AXIS_X] * ctrl->mSmpRate[DArCDJ_AXIS_X];
...
int AjpgGetInfo (const void *src, size_t src_size, int *width, int *height)
{
	...
	if (!d || src_size < DArCDJ_HEADER_SIZE || memcmp (d, "AJPG", 4))
		return 0;
	if (width)
		*width = (int)(AV_RB32 (d + 4) & 0x7ff);
	if (height)
		*height = (int)((AV_RB32 (d + 4) >> 11) & 0x7ff);
	return 1;
}

int AjpgDecodeRGBA (
	const void *src, size_t src_size, uint8_t **out_rgba, int *out_width, int *out_height)
{
	 ...
	 */
	result = cdj_d_initializeDecompressOdh (&ctrl, NULL, (u8 *)(uintptr_t)src, (u32)src_size);
	if (result)
		return 0;
	...
	odh_plane_layout (&ctrl, &luma_stride, &chroma_stride, &cb_off, &cr_off, &total);
...
int AjpgEncodeRGBA (
	const uint8_t *rgba, int width, int height, int quality, uint8_t **out_data, size_t *out_size)
{
	SArCDJ_OdhMaster ctrl;
	...
	for (;;)
	{
		...
		result = cdj_c_initializeCompressOdh (&ctrl, imgSize, (u8)quality, NULL, out, size_limit);
		if (result)
		{
			av_freep (&work);
			free (out);
