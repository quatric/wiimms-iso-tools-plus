...
void szs_sentry_init (void)
{
	...
	if (!dsn || !*dsn)
		dsn = "https://a7c5633759c90496488fbcd6c13dee64@o107347.ingest.us.sentry.io/"
			  "4512040243363840";
...
void szs_sentry_capture_message (ccp message)
{
	...
	sentry_capture_event (sentry_value_new_message_event (SENTRY_LEVEL_INFO, "custom", message));
}
