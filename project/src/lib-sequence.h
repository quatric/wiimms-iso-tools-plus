...
enum
{
	...
	SEQ_OP_BIQUAD_TYPE = 0xB4, // [u8 type]
	SEQ_OP_BIQUAD_VALUE = 0xB5, // [u8 value]
	SEQ_OP_MOD_PHASE = 0xBD, // [u8 phase]
	SEQ_OP_MOD_CURVE = 0xBE, // [u8 curve]
	SEQ_OP_FRONT_BYPASS = 0xBF, // [u8 bypass]
	...
	SEQ_OP_MOD_PERIOD = 0xE4, // [u16 period]
	SEQ_OP_ENV_RESET = 0xFB, // []
