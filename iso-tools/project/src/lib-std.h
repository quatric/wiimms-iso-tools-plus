...
typedef enum ShowMode
{
	...
	SHOW__ID = SHOW_D_ID | SHOW_P_ID,

	SHOW__PART = SHOW_P_INFO | SHOW_P_ID | SHOW_P_MAP | SHOW_CERT | SHOW_TICKET | SHOW_TMD,

	SHOW__DISC = SHOW_FILES | SHOW_D_MAP,

	SHOW__MAP = SHOW_P_MAP | SHOW_D_MAP | SHOW_W_MAP,
...
enum enumPrintTime
{
	...
	PT__MASK = PT__USE_MASK | PT__F_MASK | PT__PRINT_MASK | PT__MULTI_MASK | PT__ENABLED_MASK,
...
struct wd_disc_t;
void InsertDiscMemMap (MemMap_t *mm, // valid memory map pointer
