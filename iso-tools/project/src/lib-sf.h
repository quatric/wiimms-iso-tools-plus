...
typedef enumError (*ReadFunc) (struct SuperFile_t *sf, off_t off, void *buf, size_t count);

typedef off_t (*DataBlockFunc) (
	struct SuperFile_t *sf, off_t off, size_t hint_align, off_t *block_size);

typedef void (*FileMapFunc) (struct SuperFile_t *sf, FileMap_t *fm);

typedef enumError (*WriteFunc) (struct SuperFile_t *sf, off_t off, const void *buf, size_t count);

typedef enumError (*ZeroFunc) (struct SuperFile_t *sf, off_t off, size_t count);

typedef enumError (*FlushFunc) (struct SuperFile_t *sf);
...
void CloseDiscSF (SuperFile_t *sf // valid pointer
);
...
enumError SparseHelper (SuperFile_t *sf, off_t off, const void *buf, size_t count, WriteFunc func,
...
enumError oldDiffSF (SuperFile_t *f1, SuperFile_t *f2, int long_count, bool force_raw_mode);

enumError oldDiffRawSF (SuperFile_t *f1, SuperFile_t *f2, int long_count);

enumError oldDiffFilesSF (
	SuperFile_t *f1, SuperFile_t *f2, int long_count, struct FilePattern_t *pat, wd_ipm_t pmode);
