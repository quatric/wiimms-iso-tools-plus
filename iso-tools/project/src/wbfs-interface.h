...
enumError DumpWDiscInfo (WDiscInfo_t *dinfo, wd_header_t *iso_header, FILE *f, int indent);
...
void SortWDiscList (
	WDiscList_t *wlist, enum SortMode sort_mode, enum SortMode default_sort_mode, int unique);
...
enumError RenameWDisc (WBFS_t *w, ccp new_id6, ccp new_title, bool change_wbfs_head,
	bool change_iso_head, int verbose, int testmode);

int RenameISOHeader (void *data, ccp fname, ccp new_id6, ccp new_title, int verbose, int testmode);
