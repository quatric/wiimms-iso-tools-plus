...
enum // some constants
{
	...
	WII_MAX_PART_SECTORS = WII_N_ELEMENTS_H1 * WII_N_ELEMENTS_H2 * WII_N_ELEMENTS_H3,
	...
	WII_N_HASH_SECTOR = WII_N_ELEMENTS_H0 + WII_N_ELEMENTS_H1 + WII_N_ELEMENTS_H2,
...
ccp wd_get_compression_name (wd_compression_t compr, // compression method
