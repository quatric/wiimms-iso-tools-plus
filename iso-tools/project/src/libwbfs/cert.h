...
const cert_item_t *FindCertItem (ccp issuer, // name to search
	const cert_chain_t *cc, // not NULL: search here first
...
ccp cert_get_status_message (cert_stat_t stat, // status
	ccp ret_invalid // return value if 'stat' unknown
);

///////////////////////////////////////////////////////////////////////////////

ccp cert_get_status_name (cert_stat_t stat, // status
	ccp ret_invalid // return value if 'stat' unknown
);
...
ccp cert_get_signature_name (u32 sig_type, // signature type
...
cert_chain_t *cert_initialize (cert_chain_t *cc // NULL or pointer to structure
												// if NULL: alloc data
);

///////////////////////////////////////////////////////////////////////////////

void cert_reset (cert_chain_t *cc // valid pointer to cert chain
);

///////////////////////////////////////////////////////////////////////////////

cert_item_t *cert_append_item (cert_chain_t *cc, // valid pointer to cert chain
...
int cert_append_data (cert_chain_t *cc, // valid pointer to cert chain
...
int cert_append_file (cert_chain_t *cc, // valid pointer to cert chain
...
cert_stat_t cert_check (const cert_chain_t *cc, // valid pointer to cert chain
...
cert_stat_t cert_check_cert (const cert_chain_t *cc, // valid pointer to cert chain
...
cert_stat_t cert_check_ticket (const cert_chain_t *cc, // valid pointer to cert chain
...
cert_stat_t cert_check_tmd (const cert_chain_t *cc, // valid pointer to cert chain
...
u32 cert_fake_sign (cert_item_t *item // pointer to certificate
);
