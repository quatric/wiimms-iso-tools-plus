...
typedef enum wd_pfst_t // print-fst mode
{
	...
	WD_PFST__OFF_SIZE = WD_PFST_UNUSED | WD_PFST_OFFSET | WD_PFST_SIZE_HEX | WD_PFST_SIZE_DEC,
...
typedef enum wd_sector_status_t
{
	...
	WD_SS_M_CLEARED = WD_SS_HASH_CLEARED | WD_SS_DATA_CLEARED | WD_SS_SECTOR_CLEARED
		| WD_SS_HASH_ZEROED | WD_SS_DATA_ZEROED,
	...
	WD_SS_M_CRYPT = WD_SS_ENCRYPTED | WD_SS_DECRYPTED,
	...
	WD_SS_M_FLAGS = WD_SS_F_PART_DATA | WD_SS_F_SCRUBBED | WD_SS_F_SKELETON,
	...
	WD_SS_M_ERROR = WD_SS_INVALID_SECTOR | WD_SS_READ_ERROR,
...
typedef enum wd_reloc_t // relocation modes
{
	...
	WD_RELOC_M_DISCLOAD = WD_RELOC_M_DELTA | WD_RELOC_M_PART | WD_RELOC_F_ENCRYPT
		| WD_RELOC_F_DECRYPT | WD_RELOC_F_COPY,

	WD_RELOC_M_PARTLOAD = WD_RELOC_M_DELTA | WD_RELOC_M_PART | WD_RELOC_F_ENCRYPT
		| WD_RELOC_F_DECRYPT,
...
typedef int (*wd_read_func_t) (void *read_data, // user defined data
...
typedef void (*wd_mem_func_t) (void *param, // user defined parameter
...
typedef int (*wd_file_func_t) (struct wd_iterator_t *it // iterator struct with all infos
);

//-----------------------------------------------------------------------------
// Callback definition for wd_insert_memmap_disc_part() & wd_insert_memmap_part()

typedef void (*wd_memmap_func_t) (void *param, // user defined parameter
...
int wd_rename (void *data, // pointer to ISO data
