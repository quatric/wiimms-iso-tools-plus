...
static const InfoOption_t OptionInfo[OPT__N_TOTAL + 1] = {
	...
	{ OPT_XHELP, false, false, false, false, false, 0, "xhelp", 0, "Same as --help." },

	{ OPT_HELP_FUSE, false, false, false, false, false, 'H', "help-fuse", 0,
	...
	{ OPT_VERBOSE, false, true, false, false, false, 'v', "verbose", 0,
		"Be verbose and print more progress information." },

	{ OPT_IO, false, true, false, false, false, 0, "io", "flags",
...
static const struct option OptionLong[]
	= { { "version", 0, 0, 'V' }, { "help", 0, 0, 'h' }, { "xhelp", 0, 0, GO_XHELP },
		  { "help-fuse", 0, 0, 'H' }, { "helpfuse", 0, 0, 'H' }, { "width", 1, 0, GO_WIDTH },
		  { "quiet", 0, 0, 'q' }, { "verbose", 0, 0, 'v' }, { "io", 1, 0, GO_IO },
		  { "param", 1, 0, 'p' }, { "option", 1, 0, 'o' }, { "allow-other", 0, 0, 'O' },
		  { "allowother", 0, 0, 'O' }, { "create", 0, 0, 'c' }, { "remount", 0, 0, 'r' },
		  { "umount", 0, 0, 'u' }, { "unmount", 0, 0, 'u' }, { "lazy", 0, 0, 'l' },
...
static const InfoOption_t *option_tab_tool[]
	= { OptionInfo + OPT_VERSION, OptionInfo + OPT_HELP, OptionInfo + OPT_XHELP,
		  OptionInfo + OPT_HELP_FUSE, OptionInfo + OPT_WIDTH, OptionInfo + OPT_QUIET,

		  OptionInfo + OPT_NONE, // separator

		  OptionInfo + OPT_PARAM, OptionInfo + OPT_OPTION, OptionInfo + OPT_ALLOW_OTHER,
		  OptionInfo + OPT_CREATE, OptionInfo + OPT_REMOUNT,

		  OptionInfo + OPT_NONE, // separator

		  OptionInfo + OPT_UMOUNT, OptionInfo + OPT_LAZY,
...
const InfoUI_t InfoUI_wfuse = { "wfuse",
	0, // n_cmd
	0, // cmd_tab
	CommandInfo,
	0, // n_opt_specific
